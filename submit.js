...
module.exports = async (req, res) => {
  ...
  const autoReplyHtmlNew = `
    <div style="font-family: Georgia, serif; max-width: 560px; margin: 0 auto; color: #1A1A1A;">
      ...
      <div style="background: #FAF7F2; padding: 36px 32px; border: 1px solid #E8E0D0; border-top: none;">
        ...
        <p style="line-height:1.7; margin-bottom:16px;">You're not here by accident — and we mean that. Someone from our team will be reaching out to you personally soon. In the meantime, we've attached our <strong>Welcome Pack</strong> to this email. It has everything you need to know about who we are, what we believe, and how to take your next step with us.</p>
        <p style="line-height:1.7; margin-bottom:24px;">If you have any questions before then, feel free to reply to this email or visit us at <a href="https://pathwaym.co.za" style="color:#C9A84C;">pathwaym.co.za</a>.</p>
        ...
        <p style="line-height:1.7; margin-top:24px; margin-bottom: 0;">With love,<br><strong>The Pathway Ministries Team</strong></p>
      </div>
      <div style="padding: 16px 32px; text-align: center; font-size: 0.78rem; color: #8A7F74;">
        Pathway Ministries · Hyde Park, Johannesburg · pathwaym.co.za
      </div>
  ...
  const autoReplyHtmlReturning = `
    <div style="font-family: Georgia, serif; max-width: 560px; margin: 0 auto; color: #1A1A1A;">
      ...
      <div style="background: #FAF7F2; padding: 36px 32px; border: 1px solid #E8E0D0; border-top: none;">
        ...
        <p style="line-height:1.7; margin-bottom:16px;">Thank you for reaching out — it means a lot that you took this step. We've received your details and someone from the Pathway Ministries team will be in touch with you personally soon.</p>
        <p style="line-height:1.7; margin-bottom:16px;">In the meantime, feel free to visit us at <a href="https://pathwaym.co.za" style="color:#C9A84C;">pathwaym.co.za</a> or reach out directly at <a href="mailto:info@pathwaym.co.za" style="color:#C9A84C;">info@pathwaym.co.za</a>.</p>
  ...
  try {
    ...
    // Auto-reply to person
    const replyOptions = {
      from: `"Pathway Ministries" <${process.env.SMTP_USER}>`,
      to: email,
      subject: isNewVisitor
        ? `Welcome Home, ${firstName} — Pathway Ministries`
        : `We've received your details — Pathway Ministries`,
      html: isNewVisitor ? autoReplyHtmlNew : autoReplyHtmlReturning,
    };

    // Attach welcome pack for new visitors
    if (isNewVisitor) {
      const pdfPath = path.join(__dirname, '..', 'welcome-pack.pdf');
